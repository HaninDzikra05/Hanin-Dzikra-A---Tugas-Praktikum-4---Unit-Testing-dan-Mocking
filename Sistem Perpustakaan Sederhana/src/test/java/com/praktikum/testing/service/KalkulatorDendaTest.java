...
public class KalkulatorDendaTest {
    ...
    void testHitungDendaDosen() {
        ...
        LocalDate tanggalJatuhTempo = LocalDate.now().minusDays(3); // 5 hari terlambat
    ...
    void testGetDendaMaksimal() {
        ...
        assertEquals(15000.0, kalkulatorDenda.getDendaMaksimal(Anggota.TipeAnggota.UMUM));
    ...
    void testAdaDenda() {
        ...
        Peminjaman peminjamanTerlambat = new Peminjaman("P001", "M001", "1234567890",
                LocalDate.now().minusDays(1), tanggalJatuhTempo);
    ...
    void testDeskripsiDenda() {
        ...
        assertEquals("Denda berat", kalkulatorDenda.getDeskripsiDenda(75000.1));
    }
}