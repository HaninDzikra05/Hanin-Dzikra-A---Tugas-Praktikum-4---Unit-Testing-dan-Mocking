 ...
 *
 * TUJUAN PEMBELAJARAN:
 * - Membuat data menggunakan mock manual
...
class MockRepositoryBukuTest {
    ...
    void setUp() {
        ...
        buku3 = new Buku("111111111111", "Java Advanced", "John Doe", 4, 180000.0);
    }
    ...
    void testCariByIsbnBukuDitemukan() {
        ...
        // Assert
        assertTrue(hasil.isPresent(), "Harus mengembalikan buku2");
    ...
    void testCariByJudulCaseInsensitive() {
        ...
        // Verify judul yang dikembalikan
    ...
    @Test
    @DisplayName("CariByJudul partial match")
    ...
    void testIntegrationFlowPeminjaman() {
        // Simulasi flow lengkap peminjaman buku
