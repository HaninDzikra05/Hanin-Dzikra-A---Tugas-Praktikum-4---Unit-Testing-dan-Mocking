...
public class ValidationUtilsTest {
    ...
    @ParameterizedTest
    @ValueSource(strings = {"", " ", "email-tanpa-@.com", "email@", "@domain.com", "invalid.com"})
    ...
    void testNomorTeleponValid() {
        ...
        assertTrue(ValidationUtils.isValidNomorTelepon("087123456789"));
        assertTrue(ValidationUtils.isValidNomorTelepon("081234567890"));
    }

    @ParameterizedTest
    @ValueSource(strings = {"", " ", "123456789", "987123456789", "08123", "087123456"})
    ...
    void testStringValid() {
        ...
        assertTrue(ValidationUtils.isValidString(" valid "));
    ...
    void testValidasiAngka() {
        ...
        assertTrue(ValidationUtils.isAngkaNonNegatif(5.0));
        assertFalse(ValidationUtils.isAngkaNonNegatif(-10.0));
    }
}
