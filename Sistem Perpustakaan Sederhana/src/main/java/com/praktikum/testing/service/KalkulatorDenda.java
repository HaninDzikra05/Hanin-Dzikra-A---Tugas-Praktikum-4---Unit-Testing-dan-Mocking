...
public class KalkulatorDenda {
    ...
    private static final double TARIF_DENDA_UMUM      = 2000.0;

    // Batas maksimal denda
    private static final double DENDA_MAX_MAHASISWA = 35000.0;
    private static final double DENDA_MAX_DOSEN     = 50000.0;
    ...
    public double hitungDenda(Peminjaman peminjaman, Anggota anggota) {
        ...
        double dendaMaks   = getDendaMaksimal(anggota.getTipeAnggota());

        return Math.min(totalDenda, dendaMaks);
    }

    // Ambil tarif denda harian berdasarkan tipe anggota
    ...
    // Ambil denda maksimal berdasarkan tipe anggota
    ...
    // Deskripsi denda berdasarkan jumlah
